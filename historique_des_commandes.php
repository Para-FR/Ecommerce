...
<div class="banner-top">
    <div class="container">
        ...
        <em></em>
        <h2><a href="index.php">Accueil</a><label>/</label>Historique des Commandes</h2>
...
<div class="container">
    ...
    <div class="login">
        <div class="form-group">
            ...
            <div class="box-body">
                <?php
                $return = '';
                $tableau_suivi_commandes = executeRequete("SELECT id_commande, montant, date_enregistrement, etat FROM commande WHERE id_membre=".$_SESSION['membre']['id_membre']." AND etat='commande livree'");
    ...
    <div style=\"width:100px;\">
            ...
            <a name=\'action\' href=historique_des_commandes.php?action=consulter&element=" . $ligne['id_commande'] . " class=\"btn btn-azur btn-xs\">
            <i class=\"fa fa-eye\"></i>
            </a>
        </div>
    </div>
