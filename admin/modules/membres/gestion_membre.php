...
function do_action($action)
{
    ...
    if ($action == 'modifier') {
        ...
        if (!empty($element)) {
            ...
            $resultat_modifier = '<div class="row">
                                                <div class="col-md-10 col-md-offset-1 bg-info paddingTop20 borderRadius5">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-8 col-md-offset-2">
                                                            ...
                                                            <span class="input-group-addon" id="basic-addon1">
                                                                ...
                                                                <input type="text" class="form-control" id="inputusername_operateur" name="username_operateur" placeholder="Identifiant" value="' . $test["pseudo"] . '">
                                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4 col-md-offset-2">
                                                            <div class="input-group">
                                                                ...
                                                                <input class="form-control" id="inputpassword_operateur" autocomplete="off" name="password_operateur" placeholder="Mot de passe" value="" type="password">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="input-group">
                                                                <span class="input-group-addon" id="basic-addon1"><i class="ion ion-lock-combination"></i></span>
                                                                <input type="password" class="form-control" id="inputconfirmation_operateur" name="confirmation_operateur" placeholder="Confirmation du mot de passe" value="">
                                                            </div>
                                                            <div class="input-error under-grouped">
                                                            </div>
